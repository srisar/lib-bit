      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          ...
          <?php if ($is_overdue): ?>
            ...
            <div class="row">
              <div class="col">
                <p class="badge badge-pill badge-danger"> <?= $days_elapsed ?> day(s) have passed since returning
                  date.</p>
              </div>
            </div>
              ...
              <div class="col">
                ...
                <?php if ($has_payment): ?>
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        <label for="overdue-value">Overdue payment paid for <br>(<?= $days_elapsed ?> days
                          x <?= App::toCurrencyFormat(OVERDUE_DAY_PAYMENT) ?>)</label>
                        <input class="form-control" type="text" value="<?= App::toCurrencyFormat($overdue_payment) ?>"
                               disabled>
                      </div>
